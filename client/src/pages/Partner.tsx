...
const steps = [
  {
    num: "01",
    title: "提交申请",
    desc: "填写城市合伙人申请表，提交基本信息与合作意向",
  },
  {
    num: "02",
    title: "资质审核",
    desc: "总部团队对申请资质进行评估，1-3个工作日内反馈",
  },
  {
    num: "03",
    title: "签约授权",
    desc: "通过审核后签订合作协议，获得城市独家授权资格",
  },
  {
    num: "04",
    title: "培训上岗",
    desc: "参加总部系统培训，掌握运营方法论与课程体系",
  },
  {
    num: "05",
    title: "开城运营",
    desc: "在总部支持下启动本地招生与活动，开启合伙人之旅",
  },
];
        ...
        <div className="container">
          <div className="text-center mb-14">
            <h2
              ...
              style={{ fontFamily: "'Noto Serif SC', serif" }}
            >
              合伙人<span className="text-[#78d6c4]">核心权益</span>
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {benefits.map((b, i) => {
              ...
              return (
                <div
                  key={b.title}
                  className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-[#78d6c4]/40 hover:bg-white/8 transition-all duration-300"
                  style={{ transitionDelay: `${i * 80}ms` }}
                >
                  <div className="w-12 h-12 bg-[#78d6c4]/20 rounded-xl flex items-center justify-center mb-4">
                    <Icon className="w-6 h-6 text-[#78d6c4]" />
                  </div>
        ...
        <div className="container">
          <div className="text-center mb-14">
            <h2
              ...
              style={{ fontFamily: "'Noto Serif SC', serif" }}
            >
              合作<span className="text-[#78d6c4]">流程</span>
            </h2>
          </div>
          <div className="flex flex-col md:flex-row gap-4 md:gap-0 items-start justify-between relative">
            <div className="hidden md:block absolute top-8 left-[10%] right-[10%] h-px bg-gradient-to-r from-[#78d6c4]/20 via-[#78d6c4]/60 to-[#78d6c4]/20" />
            {steps.map((s, i) => (
              <div
                key={s.num}
                className="flex-1 flex flex-col items-center text-center px-4 relative z-10"
              >
                <div className="w-16 h-16 rounded-full bg-[#78d6c4] flex items-center justify-center text-white font-black text-lg mb-4 shadow-lg shadow-[#78d6c4]/30">
                  {s.num}
                </div>
        ...
        <div className="container text-center">
          <div className="max-w-2xl mx-auto bg-gradient-to-br from-[#78d6c4]/20 to-transparent border border-[#78d6c4]/30 rounded-3xl p-12">
            <h2
              ...
              style={{ fontFamily: "'Noto Serif SC', serif" }}
            >
              准备好开启<span className="text-[#78d6c4]">合伙人之旅</span>了吗？
            </h2>
